...
Route::prefix('api/v1')->group(function(){
 ...
 Route::middleware('session-auth')->group(function(){
  ...
  Route::middleware('role:staff')->group(function(){Route::get('settings',[SettingsController::class,'show']);Route::put('settings',[SettingsController::class,'update']);Route::post('settings/seal',[SettingsController::class,'uploadSeal']);Route::post('settings/priest-signature',[SettingsController::class,'uploadSignature']);Route::put('certificate-templates/{sacrament}',[CertificateTemplateController::class,'update']);});
  Route::get('settings/image/{type}',[SettingsController::class,'image'])->middleware('role:staff');
  Route::get('certificate-preview-settings',[SettingsController::class,'preview'])->middleware('role:staff'); Route::get('certificate-preview-image/{type}',[SettingsController::class,'image'])->middleware('role:staff');
