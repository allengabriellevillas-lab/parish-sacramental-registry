...
Route::prefix('api/v1')->group(function(){
 ...
 Route::middleware('session-auth')->group(function(){
  ...
  Route::middleware('role:admin,staff')->group(function(){Route::get('certificate-requests',[CertificateRequestController::class,'index']);Route::get('certificate-requests/{certificateRequest}',[CertificateRequestController::class,'show']);Route::put('certificate-requests/{certificateRequest}',[CertificateRequestController::class,'update']);Route::get('certificate-requests/{certificateRequest}/matches',[CertificateRequestController::class,'matches']);Route::get('certificate-requests/{certificateRequest}/attachment',[CertificateRequestController::class,'attachment']);Route::get('certificate-requests/{certificateRequest}/claim-slip.pdf',[CertificateRequestController::class,'claimSlip']);Route::post('certificate-requests/{certificateRequest}/issue',[CertificateRequestController::class,'issue']);Route::post('records',[RecordController::class,'store']);Route::post('records/{record}/issue',[IssuanceController::class,'store']);Route::get('records/{record}/certificate.pdf',[IssuanceController::class,'certificate']);Route::post('imports',[ImportController::class,'store']);Route::post('imports/{batch}/commit',[ImportController::class,'commit']);Route::delete('imports/{batch}',[ImportController::class,'destroy']);Route::get('imports/template',[ImportController::class,'template']);});
